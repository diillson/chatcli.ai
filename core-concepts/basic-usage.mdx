...
| `/compact` | Compacta o histórico de conversa (automatico ou guiado com instrucao) |
...
Para a lista completa, veja a [Referência de Comandos](/reference/command-reference#atalhos-de-teclado).
