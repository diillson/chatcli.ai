...
<Tabs>
  <Tab title="Binário (Recomendado)">
    A maneira mais fácil. Baixe o binário para seu sistema diretamente da [página de Releases](https://github.com/diillson/chatcli/releases).
