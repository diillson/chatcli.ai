...
###### Se você receber uma resposta da IA, <Tip>parabéns! O ChatCLI está pronto para ser usado.</Tip>
...
**Dica:** Use `/skill search <query>` para buscar e instalar skills de registries remotos. Veja [Skill Registry](/features/skill-registry) para mais detalhes.
