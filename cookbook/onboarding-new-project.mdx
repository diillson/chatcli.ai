...
<Step title="A Visão Panorâmica com @file --mode=summary">
...
O diretorio /cmd sugere que ha multiplos binarios.

A pasta /internal/api provavelmente contem os handlers das rotas HTTP,
enquanto /internal/database gerencia a logica de acesso ao banco de dados.

O arquivo docker-compose.yml indica que o projeto usa Docker para o
...
<Step title="Investigação Específica com @file --mode=smart">
...
<Step title="Mergulho Profundo em um Arquivo com @file --mode=full">
