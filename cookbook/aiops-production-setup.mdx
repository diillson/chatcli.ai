...
<Check>Cluster Kubernetes 1.25+</Check>
<Check>Helm 3.x instalado</Check>
<Check>Prometheus Operator (para ServiceMonitor)</Check>
<Check>Grafana (para dashboards)</Check>
<Check>Pelo menos uma API key de LLM (OpenAI, Claude, Google AI)</Check>
...
<Check>Operator instalado com 16 CRDs</Check>
<Check>Instance criada com TLS e auth</Check>
<Check>Watcher monitorando deployments alvo</Check>
<Check>NotificationPolicy com Slack + PagerDuty</Check>
<Check>EscalationPolicy L1→L2→L3</Check>
<Check>SLOs com burn rate alerting (Google SRE model)</Check>
<Check>SLAs com response/resolution time por severity</Check>
<Check>ApprovalPolicy com auto/quorum para produção</Check>
<Check>Grafana dashboards instalados</Check>
<Check>Chaos experiment validado em dry-run</Check>
<Check>Web Dashboard acessível</Check>
<Check>REST API com autenticação configurada</Check>
