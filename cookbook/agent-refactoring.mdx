...
A IA irá analisar sua solicitação e propor um plano. Um bom plano para está tarefa provavelmente terá duas etapas:
...
<Note>
Agora você pode revisar está lista. Se ela contiver um arquivo inesperado (ex: `README.md`), você sabe que a abordagem precisa ser refinada.
</Note>
