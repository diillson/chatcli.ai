...
<Step title="Crie Contextos Persistentes para Cada Projeto">
...
<Step title="Inicie o Trabalho no Projeto A">
...
```text
debug-api-projeto-a > Onde está a logica de validacao de JWT?
```

</Step>

<Step title="Alterne para o Projeto B">
...
<Step title="Retornando ao Projeto A">
