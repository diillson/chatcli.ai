...
| `BEDROCK_ANTHROPIC_ENDPOINT` | Forces the Claude wire: `mantle` (Messages endpoint) or `invoke` (legacy InvokeModel). Without it, routing is catalog-driven — Sonnet 5 goes to the Messages endpoint automatically. | per catalog |
