...
| `CHATCLI_EMBED_MODEL` | Embedding model. Provider defaults: Voyage `voyage-4`; OpenAI `text-embedding-3-small`; Bedrock `amazon.titan-embed-text-v2:0`. | provider default |
| `CHATCLI_EMBED_DIMENSIONS` | OpenAI: truncate via Matryoshka. Bedrock Titan v2: accepts 256 / 512 / 1024; Nova MME: 256 / 384 / 1024 / 3072 (others rejected). Bedrock Titan v1 / Cohere v3: fixed dim, ignored. Cohere v4: 1536 default. | model native |
