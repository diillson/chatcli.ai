...
| `CHATCLI_COMMANDS` | Master switch for [slash-command templates](/features/slash-commands) (`.chatcli/commands` + `~/.chatcli/commands`, with `.claude/commands` and `.devin/workflows` interop). Catalog shown in `/config commands`. | `true` |
