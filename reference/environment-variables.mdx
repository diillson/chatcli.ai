...
| `CHATCLI_ENV` | Modo de logging: `dev` (console colorido + arquivo), `prod` (so arquivo JSON). Compativel com legado `ENV`. | `prod` |
...
| `GOOGLEAI_MODEL` | Modelo a usar | `gemini-2.0-flash-lite` |
