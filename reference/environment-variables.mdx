...
| `CHATCLI_BUDGET_HARD_STOP` | Refuse new LLM turns (chat, agent loop, RPC/gateway) once the budget is exhausted; unblock by raising the limit or running `/cost reset` | `false` |
