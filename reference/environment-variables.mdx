...
| `OPENAI_API_URL` | Custom Chat Completions endpoint. Must be the **full** URL (ending in `/chat/completions`); the `/models` listing URL is derived from it | `https://api.openai.com/v1/chat/completions` |
