...
description: "Retorna a análise completa da IA para um insight especifico, incluindo todos os contextos de enriquecimento e ações sugeridas"
---
...
| `sourceCodeContext` | Trechos relevantes do código-fonte do repositorio da aplicação |
| `gitOpsContext` | Status do Helm/ArgoCD/Flux no momento da análise |
| `cascadeAnalysis` | Análise de falha em cascata entre servicos |
