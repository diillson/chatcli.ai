...
description: "Retorna metricas detalhadas de MTTR (Mean Time To Resolve) com breakdown por fase"
---

<ParamField query="period" type="string" default="30d">
  Periodo de analise: `7d`, `30d`, `90d`, `180d`
</ParamField>
...
<ParamField query="granularity" type="string" default="daily">
  Granularidade do historico: `hourly`, `daily`, `weekly`
</ParamField>
...
```json Response 200
{
  ...
  "mttr": {
    ...
    "byPhase": {
      ...
      "analysis": {
        "mean": "1m30s",
        "description": "Tempo de analise de root cause pela IA"
      },
      "approval": {
        "mean": "3m20s",
        "description": "Tempo de espera por aprovacao humana"
      },
      "remediation": {
        "mean": "2m55s",
        "description": "Tempo de execucao do runbook de remediacao"
      }
    },
    "history": [
      {
