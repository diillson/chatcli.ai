...
description: "Retorna o postmortem completo de um incidente, incluindo analise de root cause, timeline e action items"
---

<ParamField path="name" type="string" required>
  Nome unico do postmortem (ex: `PM-20260318-001`)
</ParamField>
