...
<Info>
The default port is **8090** but can be changed via Helm (`--set apiPort=...`). In production, expose behind an Ingress with TLS.
</Info>
...
<CardGroup cols={2}>
  <Card title="AIOps Platform overview" icon="brain" href="/features/aiops-platform">
    How the platform detects, analyzes, and remediates incidents
  </Card>
  <Card title="Kubernetes Operator" icon="dharmachakra" href="/features/k8s-operator">
  ...
  <Card title="AIOps in production" icon="rocket" href="/cookbook/aiops-production-setup">
