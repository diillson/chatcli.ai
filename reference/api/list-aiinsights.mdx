...
description: "Retorna todos os insights gerados pela IA com analise de causa raiz, scores de confianca e acoes de remediacao sugeridas para cada incidente"
---
...
## O Que Sao AI Insights?

Toda vez que a plataforma AIOps detecta um incidente, um recurso **AIInsight** e criado contendo a analise completa da IA. Isso inclui:

- **Analise de causa raiz** com score de confianca (0-100%)
- **Recomendacoes** em formato legivel por humanos
- **Acoes sugeridas** com parametros concretos (ex.: "ScaleDeployment para 5 replicas")
- **Dados de enriquecimento**: analise de logs, metricas Prometheus, contexto GitOps, analise de cascata e previsao de raio de explosao

Este endpoint e essencial para entender **como a IA raciocinou** sobre cada incidente, especialmente quando incidentes sao escalados para operadores humanos.
