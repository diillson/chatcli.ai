...
description: "Retorna todos os insights gerados pela IA com análise de causa raiz, scores de confianca e ações de remediação sugeridas para cada incidente"
---
