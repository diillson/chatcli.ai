...
description: "Retorna detalhes de uma solicitacao de aprovação especifica, incluindo a ação pendente, avaliacao do raio de impacto e histórico de aprovações"
---
