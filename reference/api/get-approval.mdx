---
title: "Obter Aprovacao"
api: "GET /api/v1/approvals/{name}"
description: "Retorna detalhes de uma solicitacao de aprovacao especifica, incluindo a acao pendente, avaliacao do raio de impacto e historico de aprovacoes"
---

<ParamField path="name" type="string" required>
  Nome unico da solicitacao de aprovacao
</ParamField>
