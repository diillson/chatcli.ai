---
title: "Obter Error Budget do SLO"
api: "GET /api/v1/slos/{name}/budget"
description: "Retorna o detalhamento do error budget de um SLO, incluindo historico de consumo"
---

<ParamField path="name" type="string" required>
  Nome unico do SLO (ex: `slo-payment-availability`)
</ParamField>
