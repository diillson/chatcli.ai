...
description: "Retorna os detalhes completos do plano de remediação, incluindo evidências de execução, informações de rollback, restrições de segurança e histórico de conversação agêntica"
icon: "wrench"
---
