...
description: "Exporta o log de auditoria completo em formato CSV ou JSON para compliance e analise externa"
---
...
<ParamField query="since" type="string" required>
  Data de inicio no formato ISO 8601 (ex: `2026-03-01T00:00:00Z`)
</ParamField>

<ParamField query="until" type="string">
  Data de fim no formato ISO 8601 (padrao: agora)
</ParamField>
...
Para exportacoes grandes (mais de 10.000 registros), a API retorna um `202 Accepted` com um link para download assincrono:
