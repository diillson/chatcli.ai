...
| `/<command>` | Invoke a [slash-command template](/features/slash-commands) from `.chatcli/commands` (project or `~/.chatcli/commands`, with Claude Code/Devin interop): `/review-pr 1326`. `/config commands` lists the catalog |
