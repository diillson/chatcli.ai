...
| `/gateway` | Roda o ChatCLI como daemon de mensageria (`start`, `status`): cada mensagem passa pelo agent loop e o progresso é transmitido via Telegram/Slack/Discord/WhatsApp/webhook — ver [Chat Gateway](/features/chat-gateway) |
