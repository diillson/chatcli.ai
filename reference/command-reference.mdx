...
| `/memory` | Ver/carregar anotacoes de memoria (today, yesterday, week, load, longterm, list, profile, topics, projects, stats, facts, compact) |
...
| `/memory longterm` | Conteudo do MEMORY.md (fatos de longo prazo) |
...
| `/memory profile` | Perfil do usuario detectado automaticamente |
