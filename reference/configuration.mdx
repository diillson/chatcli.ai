...
| Variable | Description | Default |
| :--- | :--- | :--- |
| `CHATCLI_AUTO_UPDATE` | Auto-update policy: `auto` stages updates silently in the background, `notify` shows a welcome-screen hint, `off` disables both. See [Auto-Update](/features/auto-update). | `notify` |
