...
Grep the chatcli log (`LOG_LEVEL=info` or higher) to audit everything that took the bypass.
...
<AccordionGroup>
  <Accordion title="Server won't connect">
    ...
    6. Check logs with `LOG_LEVEL=debug`
  </Accordion>
