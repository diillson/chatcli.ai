...
Multi-Agent (`<agent_call>`) and [Subagent Delegation](/en/features/subagent-delegation) (`delegate_subagent`) **are not alternatives** — they solve different problems and can coexist within the same turn:
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Progress UI" icon="chart-bar" href="/en/features/agent-progress-ui">
