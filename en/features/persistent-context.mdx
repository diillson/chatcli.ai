...
| Flag | Description |
|:-----|:----------|
| `--mode <mode>` or `-m` | Defines how files will be processed. Modes: `full`, `summary`, `chunked`, `smart`, or [`knowledge`](/en/features/knowledge-base) (documentation corpora as a keyless RAG knowledge base). |
