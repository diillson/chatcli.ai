...
For each mode's details, frontmatter, and examples: see [Advanced frontmatter in Customizable Agents](/en/features/customizable-agents#advanced-frontmatter-patterns).
