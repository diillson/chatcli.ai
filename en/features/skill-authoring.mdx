...
<Info>
**`@memory` vs `@skill`**: `@memory` stores **facts** ("the user prefers tabs"); `@skill` stores a **reusable procedure/knowledge with triggers** ("how to deploy this project"). Short fact → memory; "how to do X" → skill.
</Info>
