...
<AccordionGroup>
  ...
  <Accordion title="5. AI Insights">
    ...
    **API endpoint:** [`GET /api/v1/aiinsights`](/en/reference/api/list-aiinsights)
  </Accordion>
  ...
  <Accordion title="6. Remediations">
    ...
    **Remediation modes explained:**
    ...
    - **Agentic mode**: Shows step count in the table; use the [Get Remediation Plan API](/en/reference/api/get-remediation-detail) for the full AI conversation history

    **API endpoint:** [`GET /api/v1/remediations`](/en/reference/api/list-remediations)
  </Accordion>
  ...
  <Accordion title="7. Runbooks">
    ...
    **API endpoint:** [`GET /api/v1/runbooks`](/en/reference/api/list-runbooks)
  </Accordion>
