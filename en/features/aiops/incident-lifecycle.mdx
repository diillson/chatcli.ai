...
| `Escalated` | All automatic retries exhausted — **requires human intervention** | Yes |
...
5. **Max remediation attempts** set to 3 (default)
...
- **Attempt < MaxAttempts (3)**: The system re-analyzes with the failure context injected, potentially selecting a different runbook or strategy
