...
<Tip>To enable embedding: `CHATCLI_QUALITY_REFINE_CONVERGENCE_EMBEDDING=1` + `CHATCLI_EMBED_PROVIDER=voyage` + `VOYAGE_API_KEY`. The cascade reuses the same provider as HyDE — zero duplicate infra.</Tip>
