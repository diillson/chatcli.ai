...
<Tabs>
  ...
  <Tab title="OpenAI">
    ...
    **Models:** `text-embedding-3-small` (default, 1536-dim, $0.02/1M tokens) or `text-embedding-3-large` (3072-dim, higher quality).
  </Tab>
...
<Tip>Backfill is **bounded**: at most 25 facts per retrieve invocation. In a normal session, most of the index is embedded within the first dozens of interactions.</Tip>
