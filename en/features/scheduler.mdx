...
**Avoid** this in most cases — the right path is almost always to add the command to the allowlist via `/config security` or to use `--i-know` explicitly. Bypass is for CI/CD in ephemeral containers.
