...
<Note>Authentication errors receive immediate maximum cooldown (5m). A successful request clears all cooldown for the provider. Use `ResetCooldowns()` to clear manually (e.g., after updating credentials).</Note>
