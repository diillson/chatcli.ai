...
<Tabs>
  <Tab title="Environment Variables">
    ...
    export CHATCLI_FALLBACK_PROVIDERS="OPENAI,CLAUDEAI,GOOGLEAI,ZAI,MINIMAX,OPENROUTER,COPILOT"
  ...
  <Tab title="Server Flags">
    ```bash
    chatcli server \
      --fallback-providers OPENAI,CLAUDEAI,GOOGLEAI,ZAI,MINIMAX,OPENROUTER,COPILOT \
