...
| **Critical errors** | All `io.ReadAll`, `json.Marshal` errors handled in critical paths | Active |
| **Proto** | Meta field preserved in proto conversion (SessionData round-trip) | Active |
