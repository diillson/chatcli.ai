...
| `@tools` | Tool catalog: expands the full definition of any deferred-index tool on demand | — |
| `@park` | Pause the agent for later resume (delay, until, for_url, for_cmd) | [Agent Park](/features/agent-park) |
| `@compress`, `@recall` | On-demand reversible compression + original recovery (CCR) | [Context Compression](/en/features/context-compression) |
