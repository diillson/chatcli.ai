...
Truncated results are saved as temporary files **inside the [Session Workspace](/en/features/session-workspace)**, instead of the legacy global `/tmp/chatcli-tool-results/`:
