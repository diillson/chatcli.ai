...
description: "The AI asks and you decide in a navigable menu: 1 to 4 questions, single or multi-select and a free-text option, with the answers returning to the model in the same turn."
icon: "list-check"
---
...
Each call carries 1 to 4 questions. For every question:
