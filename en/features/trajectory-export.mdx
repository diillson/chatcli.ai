...
<Tip>
Use it with [Agent Mode](/en/core-concepts/agent-mode): run a multi-step task, then `/export` to capture the full trajectory (reasoning + tool calls + results) as a training example or for auditing.
</Tip>
...
- [Session Management](/en/features/session-management) — `/session search`, save/load/fork
