...
| Advanced | `ExecDiagnostic` | Runs a command from a read-only allowlist inside a pod | `command` (see [allowlist](/en/features/k8s-operator#execdiagnostic-allowlist)), `pod`, `container` |
