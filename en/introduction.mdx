...
<CardGroup cols={4}>
  ...
  <Card title="25+ native tools" icon="wand-magic-sparkles">
    `@coder`, `@agent`, `@diagram`, `@knowledge` and many more.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-provider" icon="shuffle" href="/en/reference/supported-models" horizontal>
    15 providers and 200+ models — OpenAI, Claude, Gemini, Grok, Ollama… switch at any time, from a single interface.
  </Card>
