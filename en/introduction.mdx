...
<CardGroup cols={2}>
  ...
  <Card title="Remote Server (gRPC)" icon="server" href="/features/server-mode">
    Run as a gRPC server with TLS and auth. Connect from any terminal, Docker, or Kubernetes.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Full Installation Guide" icon="download" href="/getting-started/installation">
    3 methods, provider configuration, OAuth, and verification.
  </Card>
