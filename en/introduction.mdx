...
<CardGroup cols={4}>
  ...
  <Card title="32 native tools" icon="wand-magic-sparkles">
    `@coder`, `@lsp`, `@proc`, `@http`, `@knowledge`, `@memory` and many more.
  </Card>
...
<CardGroup cols={2}>
  <Card title="ChatCLI (Client)" icon="terminal" href="/en/getting-started/installation">
    **1.152.0** — The binary you install and use in your terminal. Interactive mode, agent, coder, smart context, and remote server connection. <br />
  ...
  <Card title="gRPC Server" icon="server" href="/en/features/server-mode">
    **1.152.0** — Centralized deployment for teams. Clients connect via `chatcli connect` and share LLM providers, sessions, and plugins. <br />
    `ghcr.io/diillson/chatcli:1.152.0`
  </Card>
  <Card title="AIOps Operator" icon="dharmachakra" href="/en/features/k8s-operator">
    **1.152.0** — Autonomous incident detection, AI-powered analysis, and automated remediation for Kubernetes clusters. 17 CRDs, 54+ actions. <br />
    `ghcr.io/diillson/chatcli-operator:1.152.0`
  </Card>
  <Card title="Helm Charts" icon="cube" href="/en/features/artifacthub">
    **1.152.0** — Distributed via ArtifactHub and OCI registry on GHCR. <br />
...
<CardGroup cols={2}>
  <Card title="Agent Mode" icon="robot" href="/en/core-concepts/agent-mode" horizontal>
  ...
  <Card title="Coder Mode" icon="code" href="/en/core-concepts/coder-mode" horizontal>
    Software engineering with {'/coder'}: reads, edits, applies patches and runs tests in a loop with automatic rollback.
  </Card>
  <Card title="Multi-provider" icon="shuffle" href="/en/reference/supported-models" horizontal>
    14 providers and 200+ models — OpenAI, Claude, Gemini, Grok, Ollama… switch at any time, from a single interface.
  </Card>
  <Card title="Quality Harness" icon="sparkles" href="/en/features/quality/overview" horizontal>
...
<Update label="1.152" description="2026-07-05">
  - **memory** — profile lifecycle, self-healing, chat persistence and deep user expertise layer
</Update>
