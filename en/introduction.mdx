...
<CardGroup cols={2}>
  <Card title="ChatCLI (Client)" icon="terminal">
    **1.94.1** — The binary you install and use in your terminal. Interactive mode, agent, coder,
  ...
  <Card title="gRPC Server" icon="server">
    **1.94.1** — Centralized deployment for teams. Clients connect via `chatcli connect`
  ...
  <Card title="AIOps Operator" icon="dharmachakra">
    **1.94.1** — Autonomous incident detection, AI-powered analysis, and automated remediation
    for Kubernetes clusters. 17 CRDs, 54+ actions. <br />
    `ghcr.io/diillson/chatcli-operator:1.94.1`
  </Card>
  <Card title="Helm Charts" icon="cube">
    **1.94.1** — Distributed via ArtifactHub and OCI registry on GHCR. <br />
