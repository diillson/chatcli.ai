...
| Variable | Description | Default |
| --- | --- | --- |
| `CHATCLI_MOA_MODELS` | Ensemble proposers, as CSV `provider:model` (e.g. `openai:gpt-5,claudeai:claude-opus-4-7,googleai:gemini-2.5-pro`). Without it, `/moa` has no proposers and just warns. | -- |
