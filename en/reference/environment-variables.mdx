...
| `CHATCLI_THEME` | Interface color theme (chat, cards, markdown, spinners): `dark` · `light`. Switch at runtime via `/config ui theme`. See the [Theme System](/en/features/ui-theme). | `dark` |
