...
| `/moa` | Mixture-of-Agents: several models propose in parallel and an aggregator synthesizes (`CHATCLI_MOA_MODELS`) — see [Mixture-of-Agents](/en/features/mixture-of-agents) |
...
> Partial list — the full catalog (27 native tools) is in [Plugin System](/en/features/plugin-system).
