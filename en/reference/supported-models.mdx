...
<Tabs>
  ...
  <Tab title="AWS Bedrock (full catalog)">
    ...
    **Embeddings via Bedrock** — `amazon.titan-embed-text-v2:0` (default, 1024-dim, configurable 256/512/1024), `amazon.titan-embed-text-v1` (1536-dim), and Cohere `cohere.embed-english-v3` / `cohere.embed-multilingual-v3` (1024-dim). Enable with `CHATCLI_EMBED_PROVIDER=bedrock`. See [RAG + HyDE](/en/features/quality/rag-hyde).
  </Tab>
