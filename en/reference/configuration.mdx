...
| `CHATCLI_BEDROCK_CA_BUNDLE` | PEM bundle with corporate CA for TLS. Takes precedence over `AWS_CA_BUNDLE`. | No |
| `CHATCLI_BEDROCK_INSECURE_SKIP_VERIFY` | `true` disables TLS verification (insecure, troubleshooting only). | No |
