...
| `LLM_PROVIDER` | Sets the default AI provider to use. Valid values: `OPENAI`, `OPENAI_ASSISTANT`, `CLAUDEAI`, `GOOGLEAI`, `XAI`, `ZAI`, `MINIMAX`, `STACKSPOT`, `OLLAMA`, `COPILOT`, `GITHUB_MODELS`. | `"OPENAI"` |
...
| `CHATCLI_BIND_ADDRESS` | Server bind address. Use `127.0.0.1` for local access, `0.0.0.0` to expose externally. | `127.0.0.1` |
