...
<CardGroup cols={2}>
  <Card title="Context Commands (@)" icon="at" href="/en/core-concepts/context-commands">
    Inject dynamic information into your prompt: `@file`, `@git`, `@command`, `@env`, `@history`.
  </Card>
  <Card title="Agent Mode (/agent)" icon="robot" href="/en/core-concepts/agent-mode">
    Delegate complete tasks. The AI plans and executes commands with your approval.
  </Card>
  <Card title="Coder Mode (/coder)" icon="code" href="/en/core-concepts/coder-mode">
  ...
  <Card title="Skills and Plugins" icon="plug" href="/en/features/plugin-system">
...
For the full list, see the [Command Reference](/en/reference/command-reference#keyboard-shortcuts).
