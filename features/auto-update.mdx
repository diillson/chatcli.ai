...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.194.0

── What's new in v1.194.0 ────────────────────────────────────────
  ...
  https://github.com/diillson/chatcli/releases/tag/v1.194.0

  Downloading v1.194.0 (chatcli-darwin-arm64)...
  ✓ Updated to v1.194.0 — restart chatcli to use the new version.
```
...
sudo curl -fsSL -o /usr/local/bin/chatcli https://github.com/diillson/chatcli/releases/download/v1.194.0/chatcli-darwin-arm64 && sudo chmod +x /usr/local/bin/chatcli
```
...
```text
  Version: 1.194.0 (commit: 52441581)
  ✓ Auto-updated to v1.194.0
```
...
```text
  ⬆ v1.194.0 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.194.0 is available — run /update to upgrade.
```
...
🔄 Auto-update
   ...
   Current version                 1.194.0
   Latest release                  1.194.0
