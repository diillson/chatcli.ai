...
> /update
  ...
  Current: v1.169.0 · Latest: v1.170.1
  Downloading v1.170.1 (chatcli-darwin-arm64)...
  ✅ Updated to v1.170.1 — restart chatcli to use the new version.
```
...
```text
  Version: 1.170.1 (commit: 52441581)
  ✓ Auto-updated to v1.170.1
```

In `notify` mode (the default) the welcome screen shows the invitation instead:

```text
  ⬆ v1.170.1 available — run /update to upgrade
```
...
🔄 Auto-update
   ...
   Current version                 1.170.1
   Latest release                  1.170.1
