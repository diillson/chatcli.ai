...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.181.1

── What's new in v1.181.1 ────────────────────────────────────────
  ...
  Downloading v1.181.1 (chatcli-darwin-arm64)...
  ✓ Updated to v1.181.1 — restart chatcli to use the new version.
```
...
```text
  Version: 1.181.1 (commit: 52441581)
  ✓ Auto-updated to v1.181.1
```
...
```text
  ⬆ v1.181.1 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.181.1 is available — run /update to upgrade.
```
