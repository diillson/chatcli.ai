...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.181.2

── What's new in v1.181.2 ────────────────────────────────────────
  ...
  Downloading v1.181.2 (chatcli-darwin-arm64)...
  ✓ Updated to v1.181.2 — restart chatcli to use the new version.
```
...
```text
  Version: 1.181.2 (commit: 52441581)
  ✓ Auto-updated to v1.181.2
```
...
```text
  ⬆ v1.181.2 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.181.2 is available — run /update to upgrade.
```
...
🔄 Auto-update
   ...
   Current version                 1.181.2
   Latest release                  1.181.2
