...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.199.1

── What's new in v1.199.1 ────────────────────────────────────────
  ...
  https://github.com/diillson/chatcli/releases/tag/v1.199.1

  Downloading v1.199.1 (chatcli-darwin-arm64)...
  ✓ Updated to v1.199.1 — restart chatcli to use the new version.
```
...
sudo curl -fsSL -o /usr/local/bin/chatcli https://github.com/diillson/chatcli/releases/download/v1.199.1/chatcli-darwin-arm64 && sudo chmod +x /usr/local/bin/chatcli
```
...
```text
  Version: 1.199.1 (commit: 52441581)
  ✓ Auto-updated to v1.199.1
```
...
```text
  ⬆ v1.199.1 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.199.1 is available — run /update to upgrade.
```
...
🔄 Auto-update
   ...
   Current version                 1.199.1
   Latest release                  1.199.1
