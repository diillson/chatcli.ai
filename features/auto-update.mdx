...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.177.0

── What's new in v1.177.0 ────────────────────────────────────────
  ...
  Downloading v1.177.0 (chatcli-darwin-arm64)...
  ✓ Updated to v1.177.0 — restart chatcli to use the new version.
```
...
```text
  Version: 1.177.0 (commit: 52441581)
  ✓ Auto-updated to v1.177.0
```
...
```text
  ⬆ v1.177.0 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.177.0 is available — run /update to upgrade.
```
...
🔄 Auto-update
   ...
   Current version                 1.177.0
   Latest release                  1.177.0
