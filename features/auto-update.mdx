...
── ChatCLI · Update ──────────────────────────────────────────────
  ...
  Current: v1.169.0 · Latest: v1.210.3

── What's new in v1.210.3 ────────────────────────────────────────
  ...
  https://github.com/diillson/chatcli/releases/tag/v1.210.3

  Downloading v1.210.3 (chatcli-darwin-arm64)...
  ✓ Updated to v1.210.3 — restart chatcli to use the new version.
```
...
sudo curl -fsSL -o /usr/local/bin/chatcli https://github.com/diillson/chatcli/releases/download/v1.210.3/chatcli-darwin-arm64 && sudo chmod +x /usr/local/bin/chatcli
```
...
```text
  Version: 1.210.3 (commit: 52441581)
  ✓ Auto-updated to v1.210.3
```
...
```text
  ⬆ v1.210.3 available — run /update to upgrade
...
```text
  ⬆ ChatCLI v1.210.3 is available — run /update to upgrade.
```
...
🔄 Auto-update
   ...
   Current version                 1.210.3
   Latest release                  1.210.3
