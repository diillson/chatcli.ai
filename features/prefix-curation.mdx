...
Agent and coder keep their single workspace block: they carry the system prompt inside the history and cache it differently, and they already have a per-run skill quota plus real file tools to recover a deferred body with.
