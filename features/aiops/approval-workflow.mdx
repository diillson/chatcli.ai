...
<Tabs>
  ...
  <Tab title="quorum">
    **Quorum**: Requer aprovacao de `requiredApprovers` pessoas. Garante que a aprovacao nao depende de um unico individuo.
    ...
    Neste exemplo, sao necessarios pelo menos 2 aprovadores para que a acao seja executada.
  </Tab>
</Tabs>
