...
<CardGroup cols={2}>
  <Card title="Notifications and Escalation" icon="bell" href="/features/aiops/notifications">
    Multi-channel notification system and escalation policies
  </Card>
  <Card title="SLOs and SLAs" icon="gauge-high" href="/features/aiops/slo-sla">
