...
| **Theme** | Same visual language as the ChatCLI live dashboard: dark terminal palette by default, a light palette when the OS prefers light, monospace type, KPI tiles, segmented tab bar |
