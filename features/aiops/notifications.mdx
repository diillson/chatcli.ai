---
title: "Notificações e Escalacao"
sidebarTitle: "Notificações"
description: "Sistema de notificações multi-canal e escalacao automática para a plataforma AIOps do ChatCLI."
icon: "bell"
---
...
sequenceDiagram
    ...
    NE->>EP: Issue critico não acknowledged
...
<AccordionGroup>
  ...
  <Accordion title="Escalacao não avanca de nivel">
