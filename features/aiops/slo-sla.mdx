...
Avaliacao de alertas:
  page-fast-burn (14.4x):  1h=3.0x menor que 14.4  -> NAO dispara
  ticket-medium-burn (6x): 6h=2.0x menor que 6.0   -> NAO dispara
  ticket-slow-burn (3x):   24h=1.5x menor que 3.0  -> NAO dispara
