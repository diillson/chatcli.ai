...
<Tip>
Os arquivos sao limpos automaticamente com `CleanupBudgetFiles()` ao final da sessão. O modelo pode referenciar o caminho do arquivo no preview se precisar do resultado completo.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Recuperação de JSON" icon="screwdriver-wrench" href="/features/json-recovery">
    Como argumentos malformados sao corrigidos antes da execução.
  </Card>
