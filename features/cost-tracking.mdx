...
description: "Rastreie custos de token e estimativas de preço por sessão em todos os modos, com dados reais de API e orcamento configurável"
...
<Info>
A economia de cache e calculada com base na diferença entre o preço de input normal e o preço de cache read. Veja [Bootstrap e Memória](/features/bootstrap-memory) para detalhes sobre a otimização de contexto.
</Info>
