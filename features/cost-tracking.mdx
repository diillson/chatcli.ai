...
- **expired** — the prefix was lost after a pause the cache did not survive (more than 5 minutes idle, less than an hour). Counted apart because it says nothing about the prefix's stability; it is also the evidence the [hour-long TTL promotion](/features/prefix-curation) acts on.
