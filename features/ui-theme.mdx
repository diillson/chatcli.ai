...
São **11 temas** no total. A tabela mostra as **cores-chave reais** de cada paleta — `modelo` (Primary), `accent` (raciocínio), `ok` (Success) e `erro` (Danger) — além do fundo dos code blocks.

| Tema | modelo | accent | ok | erro | fundo | Estilo |
| --- | --- | --- | --- | --- | --- | --- |
| `dark` | `#B681F4` | `#38BDF8` | `#4ADE80` | `#F87171` | `#1E2030` | Padrão, fundo escuro |
| `light` | `#7C3AED` | `#0891B2` | `#16A34A` | `#DC2626` | `#F3F4F6` | Fundo claro |
| `dracula` | `#BD93F9` | `#8BE9FD` | `#50FA7B` | `#FF5555` | `#282A36` | Alto contraste roxo/rosa/ciano |
| `nord` | `#81A1C1` | `#88C0D0` | `#A3BE8C` | `#BF616A` | `#2E3440` | Ártico frio, baixa saturação |
| `tokyo-night` | `#7AA2F7` | `#7DCFFF` | `#9ECE6A` | `#F7768E` | `#1A1B26` | Azul-noturno moderno |
| `solarized-dark` | `#268BD2` | `#6C71C4` | `#859900` | `#DC322F` | `#002B36` | Solarized na base escura |
| `solarized-light` | `#268BD2` | `#6C71C4` | `#859900` | `#DC322F` | `#FDF6E3` | Mesmos tons em fundo claro |
| `gruvbox` | `#FE8019` | `#8EC07C` | `#B8BB26` | `#FB4934` | `#282828` | Retrô, quente, alto contraste |
| `catppuccin-mocha` | `#CBA6F7` | `#89DCEB` | `#A6E3A1` | `#F38BA8` | `#1E1E2E` | Pastel suave (Mocha) |
| `monokai` | `#AE81FF` | `#F92672` | `#A6E22E` | `#FF6188` | `#272822` | Clássico de editor sobre carvão |
| `one-dark` | `#61AFEF` | `#56B6C2` | `#98C379` | `#E06C75` | `#282C34` | Azul/cinza do Atom, accents suaves |
