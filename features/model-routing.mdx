...
2. It resends that turn on a **sibling model of the same provider**, as a one-turn route override: Fable → Opus 5, Opus → Sonnet 5, Sonnet → Haiku 4.5. The next turn is back on your model.
...
|---|---|
| `auto` (default) | the sibling above, when the provider's catalog has it |
