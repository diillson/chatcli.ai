...
# Campos avancados
model: "sonnet"                        # Modelo preferido para esta skill
effort: "high"                         # Nivel de esforco: low, medium, high, max
category: "testing"                    # Categoria para organizacao
version: "1.2.0"                       # Versao da skill
author: "Edilson Freitas"              # Autor
tags: testing, go, unit-tests, tdd     # Tags para busca e classificacao

# Ativacao automatica
triggers: test, testing, tdd, unittest # Keywords que auto-ativam esta skill
...
<CardGroup cols={2}>
  <Card title="triggers" icon="bolt">
    ...
    Se o usuario digitar "como escrever **testes** para este handler?", a skill e injetada automaticamente.
  </Card>
  <Card title="paths" icon="folder-tree">
    Globs de arquivos que ativam a skill quando os arquivos correspondentes estao sendo discutidos.
...
| `disable-model-invocation` | bool | `false` | Bloqueia ativacao automatica pelo modelo |
| `argument-hint` | string | — | Texto exibido no autocomplete |

<Info>Todos os campos avancados sao **opcionais** e retrocompativeis — skills existentes continuam funcionando normalmente sem alteracao.</Info>
