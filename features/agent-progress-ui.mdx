...
Quando o dispatcher executa multiplos agents em paralelo, o terminal exibe um **painel de progresso em tempo real** que mostra o estado de cada agent individualmente. Isso elimina a incerteza de "sera que ainda está rodando?" sem precisar consultar logs.
...
<Info>A latencia máxima entre um evento de mudanca e sua exibicao no terminal e de **100ms** — imperceptivel para o usuario.</Info>
