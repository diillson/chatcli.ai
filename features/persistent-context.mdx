...
| Flag | Descrição |
|:-----|:----------|
| `--mode <modo>` ou `-m` | Define como os arquivos serão processados. Modos: `full`, `summary`, `chunked`, `smart` ou [`knowledge`](/features/knowledge-base) (corpora de docs ou de código/infra como base de conhecimento RAG keyless). |
