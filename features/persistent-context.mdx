...
<Warning>**Requer um embedding provider** (`CHATCLI_EMBED_PROVIDER`). Sem provider, o `--rag` faz fallback transparente para conteúdo completo, com um aviso. É **opt-in**: sem `--rag`, o anexo se comporta exatamente como antes (zero regressão).</Warning>
