...
|-------|------|:-----------:|-----------|
| `name` | string | **Sim** | Nome do provedor: OPENAI, OPENAI_ASSISTANT, CLAUDEAI, GOOGLEAI, XAI, ZAI, MINIMAX, OPENROUTER, STACKSPOT, OLLAMA, COPILOT, GITHUB_MODELS |
