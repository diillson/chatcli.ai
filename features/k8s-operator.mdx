...
O operator tem seu próprio Helm chart dedicado em `deploy/helm/chatcli-operator/`. Um único comando instala tudo: **17 CRDs + RBAC + Deployment + Service + Dashboard**.
