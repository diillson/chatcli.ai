...
<Note>Erros de autenticacao recebem cooldown maximo imediato (5m). Um request bem-sucedido limpa todo o cooldown do provedor. Use `ResetCooldowns()` para limpar manualmente (ex: apos atualizar credenciais).</Note>
