...
- **agent_resume** — retoma um agent estacionado via `@park`. Carrega snapshot, reentra o ReAct loop com a history restaurada. Veja [Agent Park & Resume](/features/agent-park).
