...
**Evite** — quase sempre o caminho correto é adicionar o comando à allowlist via `/config security` ou usar `--i-know` explicitamente. Bypass é para CI/CD em containers efêmeros.
