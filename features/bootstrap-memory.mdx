...
<Note>
O gateway também consulta esta memória: a persona do daemon chama `@memory recall` antes de responder "não sei" a perguntas pessoais. Veja [Chat Gateway](/features/chat-gateway).
</Note>
...
<Tip>Veja [Path-Specific Rules](/features/path-rules) para documentação completa.</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Sessões" icon="floppy-disk" href="/features/session-management">
