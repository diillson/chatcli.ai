...
<Info>
Path Rules complementam o sistema de [bootstrap](/features/bootstrap-memory) (RULES.md). Enquanto RULES.md define regras globais, Path Rules define regras específicas para partes do codebase.
</Info>
