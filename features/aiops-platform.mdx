...
- [K8s Operator (configuração e exemplos)](/features/k8s-operator)
- [K8s Watcher (detalhes de coleta e budget)](/features/k8s-watcher)
- [Modo Servidor (RPCs GetAlerts, AnalyzeIssue e AgenticStep)](/features/server-mode)
- [Receita: Monitoramento K8s com IA](/cookbook/k8s-monitoring)
