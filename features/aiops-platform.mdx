...
<CardGroup cols={3}>
  ...
  <Card title="Approvals" icon="check-double" href="/features/aiops/approvals">
    ApprovalPolicy & ApprovalRequest
  </Card>
  <Card title="Multi-Cluster" icon="globe" href="/features/aiops/multi-cluster">
    ClusterRegistration & Federation
  </Card>
  <Card title="Audit" icon="scroll" href="/features/aiops/audit">
    AuditEvent (immutable trail)
  </Card>
  <Card title="Chaos Engineering" icon="explosion" href="/features/aiops/chaos">
