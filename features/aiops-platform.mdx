...
| Advanced | `ExecDiagnostic` | Executa comando de um allowlist read-only em pod | `command` (ver [allowlist](/features/k8s-operator#execdiagnostic-allowlist)), `pod`, `container` |
