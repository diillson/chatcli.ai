...
| **tool_call** | `<tool_call name="@coder" args="..." />` | Fixes rapidos, diagnostico de erros, patches pontuais, validacao pos-agent |
...
## Extensibilidade Programatica

Alem dos agents customizados via persona (carregados automaticamente), o sistema de Registry permite extensao programatica:

```go
// Registrar um agent customizado via codigo
