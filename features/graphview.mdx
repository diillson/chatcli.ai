...
| `knowledge` | The **in-core knowledge graph** (memory, skills, topics, projects, tags) — the same substrate as the [`/graph`](/features/knowledge-base) command, but interactive. |
