...
O sistema de i18n conta com **892 chaves de tradução** cobrindo todas as strings voltadas ao usuário. São 19 arquivos do projeto com wrapping `i18n.T()` completo.
