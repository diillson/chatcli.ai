...
A página [Respostas em Voz no Gateway](/features/voice-replies) cobre tudo: os modos `auto|always|never`, o toggle por conversa, a escrita *speech-aware* (sem emoji/markdown no áudio) e o transcode para voice note.
...
- [Respostas em Voz no Gateway](/features/voice-replies) — modos, toggle por conversa, speech-aware
