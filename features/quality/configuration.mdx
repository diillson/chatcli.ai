...
| `CHATCLI_EMBED_MODEL` | provider default | string | Voyage: `voyage-4` (also `voyage-4-large`/`voyage-4-lite`/`voyage-code-4`). OpenAI: `text-embedding-3-small` / `-large`. Bedrock: `amazon.titan-embed-text-v2:0` (default), `amazon.titan-embed-text-v1`, `cohere.embed-english-v3`, `cohere.embed-multilingual-v3`, `cohere.embed-v4:0`, `amazon.nova-2-multimodal-embeddings-v1:0`. |
