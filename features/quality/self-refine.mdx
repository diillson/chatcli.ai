...
<Tip>Pra habilitar o embedding: `CHATCLI_QUALITY_REFINE_CONVERGENCE_EMBEDDING=1` + `CHATCLI_EMBED_PROVIDER=voyage` + `VOYAGE_API_KEY`. O cascade reutiliza o mesmo provedor do HyDE — zero infra duplicada.</Tip>
