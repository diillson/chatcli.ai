...
Mande uma **mensagem de voz** no Telegram e a resposta volta como **voice note** — transcrição na entrada ([whisper local-first](/features/chat-gateway)), síntese na saída, com **qualquer** backend TTS configurado. Tudo aqui é **agnóstico a provedor**: do `say` do macOS ao [motor embarcado Kokoro](/features/text-to-speech).
