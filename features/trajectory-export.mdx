...
<Tip>
Use junto com o [modo Agente](/core-concepts/agent-mode): rode uma tarefa multi-step e depois `/export` para capturar a trajetória completa (raciocínio + tool calls + resultados) como exemplo de treino ou para auditoria.
</Tip>
...
- [Gerenciamento de Sessão](/features/session-management) — `/session search`, save/load/fork
