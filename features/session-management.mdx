...
- A history rewrite (auto-compact, `/compact`, microcompact, skill aging, repeated-read dedup) is recorded as a `rewrite` event; only genuinely new messages (the summary) are appended, nothing is duplicated.
