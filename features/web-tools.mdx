...
Faz o fetch de uma URL, remove o HTML e retorna o conteúdo textual limpo. Ideal para ler documentações, artigos, READMEs e qualquer pagina web.
...
Agent: Vou buscar o conteúdo da pagina.
