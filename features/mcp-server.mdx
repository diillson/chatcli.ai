...
Beyond being an MCP **client** (consuming external tools — see [MCP Integration](/features/mcp-integration)), ChatCLI can also **be a server**: other agents/clients can drive ChatCLI over the protocol.
...
- [MCP Integration](/features/mcp-integration) — ChatCLI as an MCP **client**
- [Environment Variables](/reference/environment-variables) — `LLM_PROVIDER`, `LLM_MODEL`
