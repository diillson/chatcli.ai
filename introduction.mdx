...
<CardGroup cols={3}>
  <Card title="CLI / Servidor" icon="terminal">
    **1.91.0** <br />
...
<Info>
Todas as imagens e charts são publicados automaticamente a cada release via GitHub Actions.
