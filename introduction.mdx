...
<CardGroup cols={2}>
  <Card title="ChatCLI (Cliente)" icon="terminal">
    **1.91.0** — O binário que você instala e usa no seu terminal. Modo interativo, agente, coder,
  ...
  <Card title="Servidor gRPC" icon="server">
    **1.91.0** — Deploy centralizado para equipes. Clientes conectam via `chatcli connect`
  ...
  <Card title="Operator AIOps" icon="dharmachakra">
    **1.91.0** — Detecção autônoma de incidentes, análise com IA e remediação automática
    em clusters Kubernetes. 17 CRDs, 54+ ações. <br />
    `ghcr.io/diillson/chatcli-operator:1.91.0`
  </Card>
  <Card title="Helm Charts" icon="cube">
    **1.91.0** — Distribuídos via ArtifactHub e registro OCI no GHCR. <br />
