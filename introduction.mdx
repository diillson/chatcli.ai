...
<div style={{ display: "flex", flexWrap: "wrap", gap: "6px", justifyContent: "center", marginTop: "8px", marginBottom: "16px" }}>
  <a href="https://github.com/diillson/chatcli/releases"><img src="https://img.shields.io/github/v/release/diillson/chatcli?style=flat-square&color=2563EB&label=release" alt="Latest Release" /></a>
  ...
  <a href="https://artifacthub.io/packages/helm/chatcli/chatcli"><img src="https://img.shields.io/badge/ArtifactHub-ChatCLI_Server-417598?style=flat-square&logo=artifacthub&logoColor=white" alt="ArtifactHub ChatCLI" /></a>
  <a href="https://artifacthub.io/packages/helm/chatcli-operator/chatcli-operator"><img src="https://img.shields.io/badge/ArtifactHub-ChatCLI_Operator-417598?style=flat-square&logo=artifacthub&logoColor=white" alt="ArtifactHub Operator" /></a>
</div>
...
<CardGroup cols={2}>
  <Card title="ChatCLI (Cliente)" icon="terminal">
    **1.94.1** — O binário que você instala e usa no seu terminal. Modo interativo, agente, coder,
  ...
  <Card title="Servidor gRPC" icon="server">
    **1.94.1** — Deploy centralizado para equipes. Clientes conectam via `chatcli connect`
    e compartilham provedores LLM, sessões e plugins. <br />
    `ghcr.io/diillson/chatcli:1.94.1`
  </Card>
  <Card title="Operator AIOps" icon="dharmachakra">
    **1.94.1** — Detecção autônoma de incidentes, análise com IA e remediação automática
    em clusters Kubernetes. 17 CRDs, 54+ ações. <br />
    `ghcr.io/diillson/chatcli-operator:1.94.1`
  </Card>
  <Card title="Helm Charts" icon="cube">
    **1.94.1** — Distribuídos via ArtifactHub e registro OCI no GHCR. <br />
...
<Tabs>
  ...
  <Tab title="Servidor (Docker)">
    ```bash
    docker pull ghcr.io/diillson/chatcli:1.94.1
    ```
  </Tab>
  <Tab title="Kubernetes (Helm)">
    ```bash
    helm install chatcli oci://ghcr.io/diillson/charts/chatcli --version 1.94.1
    helm install chatcli-operator oci://ghcr.io/diillson/charts/chatcli-operator --version 1.94.1
    ```
  </Tab>
</Tabs>
