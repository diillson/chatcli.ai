...
<Frame>
  <img src="/images/chatcli-hero.png" alt="ChatCLI" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Servidor Remoto (gRPC)" icon="server" href="/features/server-mode">
...
<CardGroup cols={2}>
  <Card title="Guia de Instalação Completo" icon="download" href="/getting-started/installation">
    3 métodos, configuração de provedores, OAuth e verificação.
  </Card>
