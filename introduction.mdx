...
<CardGroup cols={4}>
  ...
  <Card title="25+ tools nativas" icon="wand-magic-sparkles">
    `@coder`, `@agent`, `@diagram`, `@knowledge` e muito mais.
  </Card>
...
<CardGroup cols={2}>
  <Card title="ChatCLI (Cliente)" icon="terminal" href="/getting-started/installation">
    **1.145.1** — O binário que você instala e usa no seu terminal. Modo interativo, agente, coder, contexto inteligente e conexão remota a servidores. <br />
  ...
  <Card title="Servidor gRPC" icon="server" href="/features/server-mode">
    **1.145.1** — Deploy centralizado para equipes. Clientes conectam via `chatcli connect` e compartilham provedores LLM, sessões e plugins. <br />
    `ghcr.io/diillson/chatcli:1.145.1`
  </Card>
  <Card title="Operator AIOps" icon="dharmachakra" href="/features/k8s-operator">
    **1.145.1** — Detecção autônoma de incidentes, análise com IA e remediação automática em clusters Kubernetes. 17 CRDs, 54+ ações. <br />
    `ghcr.io/diillson/chatcli-operator:1.145.1`
  </Card>
  <Card title="Helm Charts" icon="cube" href="/features/artifacthub">
    **1.145.1** — Distribuídos via ArtifactHub e registro OCI no GHCR. <br />
...
<CardGroup cols={2}>
  <Card title="Modo Agente" icon="robot" href="/core-concepts/agent-mode" horizontal>
  ...
  <Card title="Modo Coder" icon="code" href="/core-concepts/coder-mode" horizontal>
    Engenharia de software com {'/coder'}: lê, edita, aplica patches e roda testes em loop com rollback automático.
  </Card>
  <Card title="Multi-provedor" icon="shuffle" href="/reference/supported-models" horizontal>
    15 provedores e 200+ modelos — OpenAI, Claude, Gemini, Grok, Ollama… troque a qualquer momento, numa só interface.
  </Card>
  <Card title="Harness de Qualidade" icon="sparkles" href="/features/quality/overview" horizontal>
