...
| `/memory import <caminho>` | Mescla uma exportação na memória desta máquina: fatos mantêm seus ids (os já conhecidos ficam com os metadados mais fortes), episódios deduplicam, tópicos/projetos/perfil mesclam campo a campo; nada é apagado |
