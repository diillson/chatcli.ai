...
<Tip>Self-Refine, CoVe e Reflexion trabalham em silêncio. Para ver cada padrão disparar **e o que ele concluiu** (`rewrote draft`, `found discrepancy`, `lesson saved`, …), abra a [Dash ao Vivo](/pt/features/live-dashboard#os-sete-padrões-com-desfecho) com `/dash`.</Tip>
