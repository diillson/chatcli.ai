...
<Frame caption="A página vinculada a uma sessão salva: a conversa à direita, as sessões salvas à esquerda, modo, provider e modelo no cabeçalho, o custo da sessão e o compositor com anexos, voz e geração de imagem. (Dados sintéticos.)">
  <img src="/images/web-ui.png" alt="Web UI do ChatCLI: uma conversa vinculada a uma sessão salva, com a barra de sessões, abas de modo, seletores de provider e modelo, custo e o compositor" />
</Frame>
