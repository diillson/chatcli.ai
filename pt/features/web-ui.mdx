...
<Frame caption="A página vinculada a uma sessão salva: a conversa à direita, as sessões salvas à esquerda, modo, provider e modelo no cabeçalho, o custo da sessão, o compositor com anexos, voz e geração de imagem, e o painel aberto nas skills. (Dados sintéticos.)">
  <img src="/images/web-ui.png" alt="Web UI do ChatCLI: uma conversa vinculada a uma sessão salva, com a barra de sessões, abas de modo, seletores de provider e modelo, custo, o compositor e o painel aberto nas skills" />
</Frame>
...
<Frame caption="Um passeio pela página: o painel com status, o catálogo de tools com filtro, skills e comandos; `/` e `@` abrem paletas no compositor; as abas de modo; o tema claro. (Dados sintéticos.)">
  <img src="/images/web-ui.gif" alt="Passeio animado pela web UI do ChatCLI: abrindo o painel, filtrando tools, navegando skills e comandos, as paletas de barra e arroba no compositor, trocando modo e tema" />
</Frame>
