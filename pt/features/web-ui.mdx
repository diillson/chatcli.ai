...
| `/web off` | Para |
| `chatcli web` | Serve a web UI de um terminal próprio, até `Ctrl+C` |
...
A barra lateral lista todas as sessões salvas com título. Vincule uma para continuá-la, bifurque, ou comece uma nova. Apagar é o mesmo `/session delete` que o terminal executa.
...
<CardGroup cols={2}>
  <Card title="Dashboard ao vivo" icon="chart-network" href="/pt/features/live-dashboard">
    O que cada processo está fazendo, como um grafo ao vivo. Abra do terminal da web UI com `/dash`.
  </Card>
