...
| **Tema** | Mesma linguagem visual do live dashboard do ChatCLI: paleta escura de terminal por padrão, paleta clara quando o sistema prefere claro, tipografia monoespaçada, tiles de KPI, barra de abas segmentada |
