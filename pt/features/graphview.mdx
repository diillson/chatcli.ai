...
| `knowledge` | O **grafo de conhecimento interno** (memória, skills, tópicos, projetos, tags) — o mesmo substrato do comando [`/graph`](/pt/features/knowledge-base), mas interativo. |
