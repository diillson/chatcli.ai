...
exatamente o sintoma da regressão pós-1.163.0).
...
desabilitado. Veja [Chaos Test Fixes — GAP-06](/pt/features/aiops/chaos-test-2026-05-23-fixes#gap-06-crds-nao-atualizados-no-helm-upgrade-alta-regressao-pos-1.163.0)
...
<CardGroup cols={3}>
  <Card title="Deploy com Docker e K8s" icon="docker" href="/pt/getting-started/docker-deployment">
