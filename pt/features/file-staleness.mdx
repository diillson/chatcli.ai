...
<CardGroup cols={2}>
  ...
  <Card title="Permissoes" icon="shield-halved" href="/pt/features/enhanced-permissions">
    Sistema de permissões que protege operações de escrita.
  </Card>
  <Card title="Recuperação de JSON" icon="screwdriver-wrench" href="/pt/features/json-recovery">
    Como argumentos de ferramenta sao corrigidos antes da execução.
  </Card>
  <Card title="Segurança do Coder" icon="lock" href="/pt/features/coder-security">
