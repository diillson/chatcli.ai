...
| `agent_task` | O **loop orientado a comandos (ReAct)**, que propõe comandos de shell passo a passo. Prefira `coder_task` para trabalho geral. Mesmas opções de roteamento, qualidade e escopo de sessão. |
