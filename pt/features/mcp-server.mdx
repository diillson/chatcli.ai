...
Além de ser um **cliente** MCP (consumir ferramentas externas — ver [MCP Integration](/pt/features/mcp-integration)), o ChatCLI também pode **ser um servidor**: outros agentes/clientes podem dirigir o ChatCLI via protocolo.
...
- [MCP Integration](/pt/features/mcp-integration) — ChatCLI como **cliente** MCP
- [Variáveis de Ambiente](/pt/reference/environment-variables) — `LLM_PROVIDER`, `LLM_MODEL`
