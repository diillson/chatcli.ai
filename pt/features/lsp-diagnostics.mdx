...
O mesmo motor LSP também está disponível para o **modelo** nos modos agent e coder, como a tool builtin **`@lsp`** — com um **pool de servidores por sessão** (o server inicializa uma vez por projeto e é reaproveitado entre chamadas; servidores ociosos são encerrados após 15 minutos):
