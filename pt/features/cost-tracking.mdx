...
- **expirados** — o prefixo foi perdido depois de uma pausa que o cache não sobreviveu (mais de 5 minutos ocioso, menos de uma hora). Contado à parte porque não diz nada sobre a estabilidade do prefixo; é também a evidência que a [promoção para o TTL de uma hora](/pt/features/prefix-curation) usa.
