...
| Google Gemini | Cache implícito (automático no 2.5+, favorecido pelo prefixo estável-primeiro) | ✅ (`cachedContentTokenCount`) |
...
*Recursos* explícitos de cache (`cachedContents` do Gemini, context caching da Moonshot) são um ciclo de vida à parte, com cobrança de armazenamento, e ainda não são usados.
