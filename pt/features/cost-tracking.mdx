...
| AWS Bedrock — Claude (InvokeModel, Mantle) | Mesmos marcadores, padrão de 5 minutos do wire | ✅ |
| AWS Bedrock — Converse (Amazon Nova, Claude via Converse) | `cachePoint` após os blocos de system e na última mensagem do user; os demais vendors do Converse rejeitam o bloco e seguem automáticos | ✅ (`TokenUsage` cache read/write) |
...
| OpenRouter | `cache_control` em system e na última mensagem do user para modelos `anthropic/` e `google/`; os demais vendors cacheiam automaticamente | ✅ |
