...
<Tip>A integração com keychain é automática quando o backend está disponível; sem backend, o armazenamento em arquivo é usado.</Tip>
...
<Info>O operador não expõe configuração de CORS: coloque-o atrás do seu próprio ingress ou proxy quando um dashboard web precisar alcançá-lo.</Info>
