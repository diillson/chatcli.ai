...
O terminal não fica mais preso enquanto um squad (ou qualquer run do `/coder`) trabalha: digite `/agents`, `/board`, `/mail`, `/jobs`, `/taskgraph` ou [`/dash`](/pt/features/live-dashboard) a qualquer momento e o comando executa na hora — o painel de progresso pausa, a saída imprime, o painel retoma.
