...
No macOS/Linux você também **vê o que digita**: a linha em composição aparece viva sob o painel (ou ao lado do spinner de turno) como `❯ seu texto▌`, com backspace funcionando — o ChatCLI assume a edição da linha enquanto o loop roda, então o spinner não come mais as teclas. (No Windows vale o comportamento clássico: a linha é entregue no Enter.)
