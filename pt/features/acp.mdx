...
**Templates de slash commands** — todo comando do [catálogo de slash commands](/pt/features/slash-commands) do projeto (`.chatcli/commands`, `~/.chatcli/commands`, dirs de interop Claude Code / Devin) é anunciado com seu `argument-hint` como input hint. Invocar um expande o template e o executa no modo atual da sessão, exatamente como texto digitado.
