...
── ChatCLI · Atualização ─────────────────────────────────────────
  ...
  Atual: v1.169.0 · Última: v1.196.1

── Novidades da v1.196.1 ─────────────────────────────────────────
  ...
  Baixando v1.196.1 (chatcli-darwin-arm64)...
  ✓ Atualizado para v1.196.1 — reinicie o chatcli para usar a nova versão.
```
...
```text
  Versão: 1.196.1 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.196.1
```
...
```text
  ⬆ v1.196.1 disponível — rode /update para atualizar
...
```text
  ⬆ ChatCLI v1.196.1 disponível — rode /update para atualizar.
```
...
🔄 Auto-update
   ...
   Versão atual                    1.196.1
   Última release                  1.196.1
