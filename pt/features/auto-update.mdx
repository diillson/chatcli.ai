...
── ChatCLI · Atualização ─────────────────────────────────────────
  ...
  Atual: v1.169.0 · Última: v1.207.2

── Novidades da v1.207.2 ─────────────────────────────────────────
  ...
  Baixando v1.207.2 (chatcli-darwin-arm64)...
  ✓ Atualizado para v1.207.2 — reinicie o chatcli para usar a nova versão.
```
...
```text
  Versão: 1.207.2 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.207.2
```
...
```text
  ⬆ v1.207.2 disponível — rode /update para atualizar
...
```text
  ⬆ ChatCLI v1.207.2 disponível — rode /update para atualizar.
```
...
🔄 Auto-update
   ...
   Versão atual                    1.207.2
   Última release                  1.207.2
