...
── ChatCLI · Atualização ─────────────────────────────────────────
  ...
  Atual: v1.169.0 · Última: v1.179.0

── Novidades da v1.179.0 ─────────────────────────────────────────
  ...
  https://github.com/diillson/chatcli/releases/tag/v1.179.0

  Baixando v1.179.0 (chatcli-darwin-arm64)...
  ✓ Atualizado para v1.179.0 — reinicie o chatcli para usar a nova versão.
```
...
sudo curl -fsSL -o /usr/local/bin/chatcli https://github.com/diillson/chatcli/releases/download/v1.179.0/chatcli-darwin-arm64 && sudo chmod +x /usr/local/bin/chatcli
```
...
```text
  Versão: 1.179.0 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.179.0
```
...
```text
  ⬆ v1.179.0 disponível — rode /update para atualizar
...
```text
  ⬆ ChatCLI v1.179.0 disponível — rode /update para atualizar.
```
...
🔄 Auto-update
   ...
   Versão atual                    1.179.0
   Última release                  1.179.0
