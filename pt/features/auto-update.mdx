...
── ChatCLI · Atualização ─────────────────────────────────────────
  ...
  Atual: v1.169.0 · Última: v1.199.1

── Novidades da v1.199.1 ─────────────────────────────────────────
  ...
  Baixando v1.199.1 (chatcli-darwin-arm64)...
  ✓ Atualizado para v1.199.1 — reinicie o chatcli para usar a nova versão.
```
...
```text
  Versão: 1.199.1 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.199.1
```
...
```text
  ⬆ v1.199.1 disponível — rode /update para atualizar
...
```text
  ⬆ ChatCLI v1.199.1 disponível — rode /update para atualizar.
```
...
🔄 Auto-update
   ...
   Versão atual                    1.199.1
   Última release                  1.199.1
