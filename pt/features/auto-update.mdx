...
> /update
  ...
  Atual: v1.169.0 · Última: v1.169.5
  Baixando v1.169.5 (chatcli-darwin-arm64)...
  ✅ Atualizado para v1.169.5 — reinicie o chatcli para usar a nova versão.
```
...
```text
  Versão: 1.169.5 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.169.5
```

No modo `notify` (o default), a tela de boas-vindas mostra o convite:

```text
  ⬆ v1.169.5 disponível — rode /update para atualizar
```
...
🔄 Auto-update
   ...
   Versão atual                    1.169.5
   Última release                  1.169.5
