...
── ChatCLI · Atualização ─────────────────────────────────────────
  ...
  Atual: v1.169.0 · Última: v1.210.0

── Novidades da v1.210.0 ─────────────────────────────────────────
  ...
  Baixando v1.210.0 (chatcli-darwin-arm64)...
  ✓ Atualizado para v1.210.0 — reinicie o chatcli para usar a nova versão.
```
...
```text
  Versão: 1.210.0 (commit: 52441581)
  ✓ Atualizado automaticamente para v1.210.0
```
...
```text
  ⬆ v1.210.0 disponível — rode /update para atualizar
...
```text
  ⬆ ChatCLI v1.210.0 disponível — rode /update para atualizar.
```
...
🔄 Auto-update
   ...
   Versão atual                    1.210.0
   Última release                  1.210.0
