...
description: "Paleta de cores unificada do ChatCLI: 12 temas (dark, light, grafite + 9 da comunidade), markdown temático e degradação graciosa por capacidade do terminal."
icon: "palette"
---
...
![Tema grafite](/images/themes/grafite.svg) — dark sóbrio de grafite: accents em azul calmo, cromo discreto
