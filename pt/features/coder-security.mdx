...
|------------|---------------------------|
| **ACP** (IDE) | Abre o dialog nativo da IDE via `session/request_permission`; negação bloqueia e o modelo replaneja |
| **MCP** com capability `elicitation` | Abre um formulário de aprovação via `elicitation/create` no cliente |
