...
```
/config compression            # painel: modo, perfil, threshold, store CCR, economia — cada linha com a sua variável (CHATCLI_COMPRESSION, _PROFILE, _THRESHOLD, _CCR_DIR, _CCR_MAX_MB, _CCR_TTL); o /config conhece o default e a origem de cada uma
