  ...
  "data": {
    ...
    "events": [
      ...
      },
      {
        ...
        "description": "AIInsight criado — análise por IA iniciada (claude/claude-sonnet-4-6)"
      },
      {
...
<CardGroup cols={2}>
  ...
  <Card title="Grafana" icon="chart-mixed">
    Consulte [Web Dashboard e Grafana](/pt/features/aiops/web-dashboard) para dashboards pré-configurados.
  </Card>
</CardGroup>
