...
Grep no log do chatcli (`LOG_LEVEL=info` ou maior) para auditar tudo que passou pelo bypass.
...
<AccordionGroup>
  <Accordion title="Servidor não conecta">
    ...
    6. Verifique logs com `LOG_LEVEL=debug`
  </Accordion>
