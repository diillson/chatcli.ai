...
| `/<comando>` | Invoca um [template de slash command](/pt/features/slash-commands) de `.chatcli/commands` (projeto ou `~/.chatcli/commands`, com interop Claude Code/Devin): `/review-pr 1326`. `/config commands` lista o catálogo |
