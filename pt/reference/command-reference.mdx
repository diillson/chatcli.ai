...
`chatcli acp` — roda o ChatCLI sobre o **Agent Client Protocol** (stdio): modos de sessão chat/agent/coder, updates estruturados de tool call e plano, slash commands do prompt da IDE e dialogs nativos de permissão, para IDEs JetBrains, Zed e qualquer cliente ACP. Ver [ACP — ChatCLI dentro da sua IDE](/pt/features/acp).
