...
| Variável | Descrição | Padrão |
| :--- | :--- | :--- |
| `CHATCLI_AUTO_UPDATE` | Política de auto-update: `auto` aplica em staging silencioso em background, `notify` mostra aviso na tela de boas-vindas, `off` desliga ambos. Veja [Auto-Update](/pt/features/auto-update). | `notify` |
