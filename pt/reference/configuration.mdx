...
| `OPENAI_API_URL` | Endpoint customizado de Chat Completions. Deve ser a URL completa terminando em `/chat/completions`; a URL de listagem `/models` é derivada dela. | Não |
