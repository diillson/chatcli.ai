...
<Info>
A porta padrão é **8090** mas pode ser alterada via Helm (`--set apiPort=...`). Em produção, exponha atrás de um Ingress com TLS.
</Info>
...
<CardGroup cols={2}>
  <Card title="AIOps Platform — visão geral" icon="brain" href="/pt/features/aiops-platform">
  ...
  <Card title="Incident lifecycle" icon="siren-on" href="/pt/features/aiops/incident-lifecycle">
