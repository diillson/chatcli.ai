...
<Update label="1.211" description="2026-09-25">
  - **chat** — let the assistant propose switching to coder mode, confirmed by the user
  - **operator** — authenticate to JWT-secured Instances and type the RS256, issuer, audience and operator credential fields
  - **operator** — book the tokens the server reports and price replies on the wire
  - **operator** — integration suite runs the controllers against a real API server
  - **operator** — make dash-preview target serves the web dashboard without a cluster
  - **operator** — probe the running server for version and health, and type mutual TLS on the Instance
  - **operator** — restyle the web dashboard to the live dashboard's language
  - **operator** — theme and language switchers on the web dashboard
  - **operator** — type the server features, pod scheduling and service account annotations on the Instance
  - **operator** — wire the decision engine, cluster tier, convergence detector, federation checks and audit events
  - **server** — accept RS256 and mTLS as startup credentials, name certificate callers and rate limit by subject
  - **server** — route every prompt RPC through streaming, fallback chain, catalog max tokens and usage attribution
  - **server** — serve the full ChatCLI turn engine over gRPC with ChatTurn, RunCoder, RunAgent and tool RPCs
  - **server** — stream watcher alerts to the operator instead of polling
  - **web** — /web command opens the browser app on the terminal session, config section and composer routing
  - **web** — bundled web application page
  - **web** — local web UI backend on the shared engine with streamed turns and browser permissions
  - **deploy** — repair stale server and operator artifacts and scope the docs version bump
  - **server** — make the alert stream overflow test deterministic
</Update>

<Update label="1.210" description="2026-09-24">
  - **catalog** — Opus 5.5 and the September model launches, self-healing Claude Code fingerprint, refusals name their category
</Update>

<Update label="1.209" description="2026-09-22">
  - **agent** — a refused turn falls back to a sibling model, and skill evolution shows on the dashboard
</Update>

<Update label="1.208" description="2026-09-22">
  - **plugins** — @dash tool lets the agent manage and read the live dashboard
  - **pulsedash** — essentials on the live dashboard page
  - **pulsedash** — the dashboard in the deck's terminal look
  - **pulsedash** — session card follows the model that serves the next request
</Update>

<Update label="1.207" description="2026-09-21">
  - **pulsedash** — let nodes be dragged into place on the live dashboard
  - **pulse** — show token usage, cost and context window on the live dashboard
</Update>

<Update label="1.206" description="2026-09-21">
  - **dash** — add the dash command and wire the run and LLM request taps
  - **pulse** — add the live telemetry bus and its disk spool
  - **pulsedash** — add the live telemetry dashboard server and page
  - **pulse** — hang each LLM request from the agent that made it
  - **pulse** — meter the tokenizer, self-update, release check and OTLP clients
  - **pulse** — report background work on the live dashboard
  - **pulse** — report outbound connections on the live dashboard
  - **pulse** — report the MCP and ACP server surfaces and the scheduler daemon
  - **pulse** — report the seven harness patterns and what each one concluded
  - **pulse** — report tools, MCP servers, skills and chat turns on the live dashboard
  - **runs** — allow keyed observers on the run registry and the request auditor
  - **utils** — stream event-stream responses through the logging transport
</Update>

<Update label="1.205" description="2026-09-15">
...
<Update label="1.204" description="2026-09-14">
...
<Update label="1.203" description="2026-09-14">
...
<Update label="1.202" description="2026-09-13">
...
<Update label="1.201" description="2026-09-10">
...
<Update label="1.200" description="2026-09-09">
...
<Update label="1.199" description="2026-09-07">
...
<Update label="1.198" description="2026-09-05">
