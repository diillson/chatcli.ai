...
Defina `CHATCLI_AUTO_UPDATE=auto` para aplicar em staging silencioso em background: o próximo start abre na versão nova. O default (`notify`) mostra o aviso na tela de boas-vindas. Veja [Auto-Update](/pt/features/auto-update) para o quadro completo.
